...
//clase de lista de verificacion
public class ListaVerificacion {
	...
	//punto de control del ArrayList
	public ArrayList<PuntoControl> getPuntosControl() {
		return puntosControl;
	}

	//añade puntos de control con su codigo y descripcion a un arraylist y lo devuelve
	...
	//metodo que calcula el porcentaje de completado
